...
AUTO                           : A U T O;
AUTOBACKUP                     : A U T O B A C K U P;
...
CHANGE                         : C H A N G E;
CHANGETRACKING                 : C H A N G E T R A C K I N G;
...
DATAGUARDCONFIG                : D A T A G U A R D C O N F I G;
...
DEFAULT_COLLATION              : D E F A U L T '_' C O L L A T I O N;
...
PARAMETERFILE                  : P A R A M E T E R F I L E;
...
XS                             : X S;
XTRANSPORT                     : X T R A N S P O R T;
YEARS                          : Y E A R S;
YEAR                           : Y E A R;
YES                            : Y E S;
...
ORACLE_DATAPUMP : O R A C L E '_' D A T A P U M P;
ORACLE_HDFS     : O R A C L E '_' H D F S;
